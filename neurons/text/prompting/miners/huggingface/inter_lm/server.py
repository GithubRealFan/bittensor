...
class InternlmMinerProcessor:

    def __init__(self, device):
        self.tokenizer = AutoTokenizer.from_pretrained('internlm/internlm-chat-7b-8k', trust_remote_code=True)
...
processors = [InternlmMinerProcessor(device=i) for i in range(num_gpus)]  # Assuming 8 GPUs
